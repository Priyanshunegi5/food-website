...
import CommingSoon from '@/app/(pages)/about/_components/comming-soon'

export default function Awards() {
    return (
        <section className="relative">
            <div className="absolute mx-auto w-full h-full bg-white bg-opacity-80 dark:bg-black dark:bg-opacity-95 z-20">
                <CommingSoon />
            </div>

            <div className="max-w-6xl mt-12 mx-auto rounded-3xl bg-gradient-to-r px-6 py-16 text-center z-10 pointer-events-none">
                <div className="relative m-auto max-w-xl">
                    ...
                    <p className="mt-4 font-dm-sans text-desktop-paragraph text-slate-body">
                        Experience the vibrant flavors of India right at your
                        fingertips! Download our app,
                    </p>
