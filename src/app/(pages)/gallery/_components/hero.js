        ...
        <section className="">
            <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20">
                ...
                <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
                    Revolutionize Your
                    {/* Empasize */}
                    <span class="relative whitespace-nowrap text-white-600 dark:text-gray-300">
                        {' '}
                        Eating
                    </span>
                    {/* Highlights */}
                    <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
                        <svg
                            aria-hidden="true"
                            viewBox="0 0 418 42"
                            class="absolute top-2/3 left-0 h-[0.58em] w-full fill-naples-yellow-400 dark:fill-naples-yellow-400"
                        ...
                        <span class="relative text-naples-yellow-400 dark:text-naples-yellow-400 ">
                            with Us
                        </span>
                    </span>
                </h1>
